...
public class UserSeeding
{
    ...
    public UserSeeding( UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager,
    ...
    {
        await CreateUsersAndClaims( _userManager, _roleManager, _configuration );
    }

    private async Task CreateUsersAndClaims( UserManager<ApplicationUser> userManager,
    ...
    private async Task<ApplicationUser?> CreateUser( UserManager<ApplicationUser> userManager,
    ...
    public static void SeedApplication( WebApplication app )
    {
        ...
        //Seed Users
        var userSeeding = new UserSeeding( userManager, roleManager, app.Configuration );
    ...
    public static async Task<ApplicationUser?> IsValidLoginInfo( UserManager<ApplicationUser> userManager,
                                                                 UserCredentials userRecord )
    {
        //Accepting username or email for login
        var user = await userManager.FindByEmailAsync( userRecord.Username ) ??
                   await userManager.FindByNameAsync( userRecord.Username );
